    ...
    public void receive(@Payload List<PaymentResponseAvroModel> messages,
        ...
        messages.forEach(paymentResponseAvroModel -> {
            try {
                ...
                // NO-OP for optimistic locking exception
                log.error("OptimisticLockingFailureException occurred while processing payment response for order id: {}",
                        paymentResponseAvroModel.getOrderId(), e);
            } catch (OrderNotFoundException e) {
                log.error("OrderNotFoundException occurred while processing payment response for order id: {}",
                        paymentResponseAvroModel.getOrderId(), e);
            }
        });
    }
