...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    private OrderApprovalOutboxMessage getUpdatedApprovalOutboxMessage(OrderApprovalOutboxMessage
                                                                       ...
                                                                       SagaStatus
                                                                               sagaStatus) {
        orderApprovalOutboxMessage.setProcessedAt(ZonedDateTime.now(ZoneId.of(TIMEZONE_ID)));
    ...
    private OrderPaymentOutboxMessage getUpdatedPaymentOutboxMessage(String sagaId,
        ...
        orderPaymentOutboxMessage.setProcessedAt(ZonedDateTime.now(ZoneId.of(TIMEZONE_ID)));
